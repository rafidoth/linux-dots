...
export function getProblemIDContext(problemId) {
  return `
...
export const getProblemUnderstandingPrompt = () => {
  return `
...
export const getSolutionApproachDiscussionPrompt = (summary, problemId) => {
