...
const ExamBtn = ({ quizsetId, quizsetTitle }) => {
  ...
  return (
    <Dialog>
      ...
      <DialogContent
        className={`font-inter font-[500] text-lg min-w-[calc(100vw-100px)] min-h-[calc(100vh-100px)] bg-black/50 backdrop-blur-[2px] rounded-2xl border border-white/10 
          before:content-[''] before:absolute before:inset-0 before:rounded-2xl before:border before:border-white/20 text-white
          `}
      >
        <DialogHeader>
        ...
        <div className="flex justify-between">
          <div className="flex flex-col gap-y-10 w-1/2">
            <div className="flex flex-col gap-y-2 items-start">
              ...
              <div
                className="flex flex-col border rounded-2xl p-4 hover:bg-accent cursor-default"
                onClick={() => {
          ...
          <div className="w-1/2">
            <span className="text-xl font-[600]">Previously Created</span>
            <div className="w-full h-[400px] flex flex-col justify-center items-center">
              <span className="text-3xl font-[800] text-muted-foreground opacity-25">
                No exams created yet on{" "}
              </span>
              <span className="text-3xl font-[800] text-muted-foreground opacity-25">
                {quizsetTitle}
              </span>
