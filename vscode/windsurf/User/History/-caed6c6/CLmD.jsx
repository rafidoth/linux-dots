...
const QuizCard = ({ quiz, index, contextFieldOpen }) => {
  ...
  return (
    <div
      ...
      } flex flex-col justify-between  break-inside-avoid p-4 shadow-md inset-shadow-2xs border border-gray-500/30    mb-4 rounded-3xl bg-neutral-200/20 backdrop-blur-[2px]`}
    >
      <div>
      ...
      <div className="flex flex-col">
        <div className="flex items-center gap-2 mt-3 justify-evenly">
          ...
          <Button variant={"outline"} className="w-42">
        ...
        <div className="flex items-center gap-2 mt-3 justify-evenly">
          <Button
            variant={"outline"}
            className="w-42 hover:bg-blue-800/20 hover:text--600"
          >
            Edit <PencilLine size={18} />
          </Button>
          <Button
            variant={"outline"}
            className="w-42 transition-all duration-500 hover:bg-red-800/20 hover:text-red-600"
          >
