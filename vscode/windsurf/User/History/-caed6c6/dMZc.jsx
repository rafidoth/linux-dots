...
const QuizCard = ({ quiz, index, contextFieldOpen }) => {
  ...
  return (
    <div
      ...
      } flex flex-col justify-between  break-inside-avoid p-4 shadow-md inset-shadow-2xs border border-gray-500/30    mb-4 rounded-3xl bg-neutral-200/10 backdrop-blur-[1px]`}
    >
      <div>
