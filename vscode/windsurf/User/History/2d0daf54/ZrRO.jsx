...
export default function Exam() {
  ...
  useEffect(() => {
    const fetchExamData = async () => {
      ...
      setLoading(true);
      try {
        // TODO: Replace with actual API call to fetch exam details once backend endpoint is ready
        // This is a placeholder to simulate fetching exam data
        // In a real implementation, we would have an API endpoint to fetch exam details by ID
        ...
        const mockExam = {
          ...
          duration_minutes: 30,
          quizsetId: "some-quizset-id", // This would come from real API
          examPreferences: {
            creatorAllowed: true,
            shuffle: true,
            isPublic: false,
        ...
        // Fetch the quizset data for this exam
        if (mockExam.quizsetId) {
          const quizsetData = await fetchQuizset(
            mockExam.quizsetId,
            session.user.id
          );
