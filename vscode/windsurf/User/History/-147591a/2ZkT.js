      ...
      parameters: {
        ...
        properties: {
          approachType: {
            type: "string",
            description:
              "The type of approach being discussed. it can be 'naive'/ 'optimized'/'optimized-2', You're given a list of solution types, where you can get the the type of solution with different approaches.",
          },
        },
