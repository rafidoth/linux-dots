...
export function generateMultipleChoiceQuestion(n, context, instructions) {
  const result = generateObject({
    ...
    Also generate a generic title (title should be concise and engaging like a book title) for the whole context. Put the title in each of the quizzes, title field.
