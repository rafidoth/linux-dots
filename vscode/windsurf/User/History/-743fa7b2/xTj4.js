...
export function generateMultipleChoiceQuestion(n, context, instructions) {
  const result = generateObject({
    ...
    Also generate a generic title (title should be concise and engaging like a book title) for the whole context. Put the title in the 0th indexed quiz of the array only. 
    
    Return the questions as an array of objects with the following structure:
    {
      question: string,
