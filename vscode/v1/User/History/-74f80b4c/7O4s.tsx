...
export default function LoginForm({ student }: Props) {
  ...
  const { updateStudentID, updateStudentInfo } = useStudentData();
  ...
  const handleSignIn = () => {
    ...
    startTransition(async () => {
      ...
      if (success === false) {
        ...
        const studentPersonalInfo: z.infer<typeof StudentInfoSchema> = StudentInfoSchema.parse({
          name: res1.name,
          email: res1.email,
        ...
        updateStudentInfo(studentPersonalInfo));
