...
describe('Testing User Campaigns Screen without Params',()=>{
          ...
          <Provider store={store}>
            <I18nextProvider i18n={i18nForTest}>
              <Routes>
                ...
                <Route
                  path="/"
                  element= {<div data-testid="paramsError">Error : orgId not found</div>}
                />
              </Routes>
            </I18nextProvider>
          </Provider>
...
describe('Testing User Campaigns Screen', () => {
  ...
  beforeAll(() => {
    vi.mock('react-router-dom', async () => {
      ...
      return {
        ...actual, 
        useParams: ()=>{{orgId : 'orgId'}}, // Mock `useParams`
        };
    });
  });
