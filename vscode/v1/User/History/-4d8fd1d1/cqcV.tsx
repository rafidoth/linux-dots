      ...
      <div className="flex gap-2 border-none w-[400px]">
        <div className="flex w-1/2">
          ...
          <div className="flex flex-col h-full">
            <div className="h-1/2 flex items-center hover:text-jigao cursor-pointer bg-zinc-700 w-[50px]">
              <FaCaretUp />
            </div>
            <div className="h-1/2 flex items-center hover:text-jigao cursor-pointer">
              <FaCaretDown />
            </div>
          </div>
        </div>
