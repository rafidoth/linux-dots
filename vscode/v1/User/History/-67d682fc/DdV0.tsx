  ...
  return (
    <ScrollArea className="h-screen">
      <div className="p-16 flex flex-wrap gap-10">
        <Card className="w-[700px] hover:bg-zinc-900 flex items-center justify-center">
          <span className="text-4xl">Create A Group Session</span>
        </Card>
        {gsInfo &&
    ...
    >
      <CardHeader>
        ...
        <div className="flex justify-between my-2">
          ...
          <span
            className={cn(
              "font-semibold cursor-pointer hover:opacity-80 flex items-center",
              smooth_hover
            )}
          >
            {" "}
