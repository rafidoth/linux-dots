  ...
  return (
    <ScrollArea className="h-screen">
      <div className="p-16 flex flex-wrap gap-10">
        <Card
          className="max-w-[700px] hover:bg-zinc-900 flex items-center justify-center"
          onClick={() => {
    ...
    >
      <CardHeader>
        ...
        <div className="flex justify-between my-2">
          <span className="flex flex-col  gap-x-4 font-semibold">
          ...
          <div className="flex flex-col justify-end gap-x-4">
            <span
              className={cn(
