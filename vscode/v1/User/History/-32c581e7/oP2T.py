...
class CodeExecutionAnimation(Scene):
    ...
    return arr'''
        ...
        # Fixed line highlighting method
        code_lines = code.code
        
        # Highlight first line and function definition
        self.play(code_lines[0].animate.set_color(YELLOW))
        self.wait(1)
        ...
        for i in range(n):
            ...
            self.play(
                code_lines[1].animate.set_color(YELLOW),
                code_lines[0].animate.set_color(WHITE)
            )
        ...
        self.play(
            code_lines[4].animate.set_color(YELLOW),
            code_lines[3].animate.set_color(WHITE)
        )
        self.wait(1)
...
# Configuration class for social media output
