...
export const fakeGroupSessionInfos: GroupSessionInfoType[] = [
  {
    ...
    previewParticipants: [
      ...
      { id: "p3", name: "Charlie", photoLink: "https://i.pravatar.cc/150?img=7" },
  ...
  },
  {
    ...
    previewParticipants: [
      { id: "p6", name: "Frank", photoLink: "https://i.pravatar.cc/150?img=10" },
      { id: "p7", name: "Grace", photoLink: "https://i.pravatar.cc/150?img=11" },
      { id: "p8", name: "Henry", photoLink: "https://i.pravatar.cc/150?img=12" },
      { id: "p9", name: "Isabel", photoLink: "https://i.pravatar.cc/150?img=13" },
      { id: "p10", name: "Jack", photoLink: "https://i.pravatar.cc/150?img=14" },
    ],
  },
  {
    id: "fakeGSession3",
    ...
    previewParticipants: [
      { id: "p11", name: "Kate", photoLink: "https://i.pravatar.cc/150?img=15" },
      { id: "p12", name: "Leo", photoLink: "https://i.pravatar.cc/150?img=16" },
      { id: "p13", name: "Mia", photoLink: "https://i.pravatar.cc/150?img=17" },
      { id: "p14", name: "Noah", photoLink: "https://i.pravatar.cc/150?img=18" },
      { id: "p15", name: "Olivia", photoLink: "https://i.pravatar.cc/150?img=19" },
    ],
  },
  {
    id: "fakeGSession4",
    ...
    previewParticipants: [
      { id: "p16", name: "Paul", photoLink: "https://i.pravatar.cc/150?img=20" },
      { id: "p17", name: "Quinn", photoLink: "https://i.pravatar.cc/150?img=21
