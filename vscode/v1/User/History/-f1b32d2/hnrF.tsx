...
const hovered: string = "hover:bg-jigao/30 border border-jigao";
const option: string =
  "bg-jigao rounded-sm w-[24px] h-[24px] py-1 border border-transparent px-3";
    ...
    <Card className={cn("w-[600px] p-2 text-2xl", "border-none")}>
      ...
      <CardContent className="flex gap-2 w-full ">
        <div className="flex flex-col gap-2 w-1/2">
          <span className={hovered} onClick={() => handleSelect(0)}>
            <span className={option}>a</span>{" "}
            <span className={}>{quiz.options[0].choiceText}</span>
          </span>
          <span className={hovered} onClick={() => handleSelect(1)}>
            <span className={option}>c</span> {quiz.options[1].choiceText}
          </span>
        </div>
        <div className="flex flex-col gap-2 w-1/2">
          <span className={hovered} onClick={() => handleSelect(2)}>
            <span className={option}>b</span> {quiz.options[2].choiceText}
          </span>
          <span className={hovered} onClick={() => handleSelect(3)}>
