        ...
        <div className="flex flex-col ">
          ...
          {Quizsets.length > 0 &&
            Quizsets.map((quizset, index) => {
              ...
              `}
                  >
                    <EditableTitle initialTitle={quizset.title!.slice(0, 20)} />
                    <Popover>
                      <PopoverTrigger>
                        <SlOptions className="hover:text-jigao" />
                      </PopoverTrigger>
                      <PopoverContent className="flex flex-col text-xl">
                        <span
                          onClick={() => setEditableTitle(index)}
                          className="flex items-center gap-2 cursor-pointer hover:text-jigao"
                        >
                          <MdEditSquare /> Rename
                        </span>
                        <span className="flex items-center gap-2 cursor-pointer hover:text-red-500">
                          <FaTrashAlt /> Rename
                        </span>
                      </PopoverContent>
                    </Popover>
