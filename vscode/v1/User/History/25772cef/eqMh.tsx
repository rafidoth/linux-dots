  ...
  return (
    <>
      <div className="w-screen h-screen flex justify-cente dark:bg-black ">
        <div
          className={`w-full flex justify-center p-10 m-10 dark:bg-zinc-950 rounded-xl overflow-auto scrollbar scrollbar-thumb-zinc-800`}
        >
                ...
                return (
                  <div key={index}>
                    ...
                    {quiz.options.map((option) => {
                      return (
                        <div key={option.choiceText}>{option.choiceText}</div>
                      );
                    })}
                  </div>
                );
