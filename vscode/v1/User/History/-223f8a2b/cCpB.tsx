...
const services = [
  {
    ...
    icon: <TbWorld width={64} height={64} />,
  },
  {
    title: "Text",
    ...
    <div className={`w-full h-full p-10 gap-4 flex flex-wrap`}>
      {services.map((service) => {
        return (
          <Card
            key={service.title}
            className={`w-[400px] h-[250px] flex  flex-col justify-between bg-transparent hover:text-white/50 transition delay-75 duration-300 ease-in-out hover:border-2 cursor-pointer`}
          >
