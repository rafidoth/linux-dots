      ...
      {services.map((service) => {
        return (
          <Link href={service.route} key={service.title}>
            <Card
              className={`w-[400px] h-[250px] flex  flex-col justify-between bg-transparent hover:text-accent transition delay-75 duration-300 ease-in-out hover:border-2 cursor-pointer`}
            >
