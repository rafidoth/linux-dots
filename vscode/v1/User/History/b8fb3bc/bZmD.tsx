...
import { RowBorderedBox, RowBorderedBoxHeader, RowBorderedBoxRow } from "@/app/ui/RowBorderedBox";
import {
  SelectContent,
  SelectItem,
  SelectTrigger,
...
const style1 =
  "w-full h-[50px] flex items-center text-2xl bg-amber-800/20 my-5 px-4 text-amber-500 rounded-xl";
  ...
  return (
    <div className="my-10">
      ...
      <div className="w-full flex gap-x-4">
        ...
        >
          <SelectTrigger className="bg-amber-800/20 text-amber-500 text-2xl px-3 py-2 border-none w-1/2 h-[50px]">
            <SelectValue placeholder="Gender" />
          </SelectTrigger>

          <SelectContent className="bg-amber-800/20 border-none">
      ...
      <div className="my-4">
        <DateTimePicker
          ...
          classnames="bg-amber-800/20 px-4 py-3 rounded-md text-amber-500 text-2xl"
          timeClock="hide"
          year={true}
        />
      </div>
      <div className="my-15">
        ...
        <span className="flex items-center text-xl gap-x-2">
          ...
          />
            ...
            <RowBorderedBoxRow></RowBorderedBoxRow>
          </RowBorderedBox>
        </div>
      </div>
