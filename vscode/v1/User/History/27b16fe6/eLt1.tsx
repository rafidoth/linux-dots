...
import { hover_style, theme_border, theme_style } from "@/app/ui/CustomStyles";
  ...
  if (myProfile) {
    return (
      <div className="flex flex-col items-center">
        {unsaved && (
          <div className="w-full bg-orange-800/10 py-2 flex justify-center">
            <span className={cn(hover_style, theme_style)}>Save Changes</span>
          </div>
        )}
