    ...
    <main className={`w-full  flex flex-col justify-center items-center`}>
      ...
      >
        ...
        >
          ...
          <div
            className={`${inter.className} motion-preset-shrink font-black my-6 text-9xl rounded-md `}
          >
            <span
              className={`relative mx-2 px-2 rounded-sm dark:text-white dark z-20`}
            >
              GPT For Quiz
              <div className="absolute w-full h-full bg-jigao blur-xl z-10"></div>
            </span>
          </div>
          <div
