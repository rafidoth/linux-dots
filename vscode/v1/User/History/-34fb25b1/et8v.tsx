      ...
      >
        {TABS.map((tab, index) => (
          <button
            ...
            data-id={tab}
            type="button"
            className="px-2 py-0.5 text-zinc-600 transition-colors duration-300 hover:text-zinc-950 dark:text-zinc-400 dark:hover:text-zinc-50 dark:hover:bg-zinc-900"
          >
            {tab}
          </button>
        ))}
