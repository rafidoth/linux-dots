    ...
    <div className="flex min-h-svh justify-center  p-6 md:p-10">
      <Tabs defaultValue="student" className="w-fit">
        ...
        <TabsContent value="student" className="">
          <span className="text-3xl font-semibold bg-orange-800/20 px-2 text-orange-500 rounded-md">
            Create Student Account
          </span>
        </TabsContent>
        <TabsContent value="mentor">
          <span className="text-3xl font-semibold bg-amber-800/20 px-2 text-amber-500 rounded-md">
