...
import { joinGroupSession } from "@/app/lib/student/mutations";
      ...
      {gsInfo && (
        ...
        >
          ...
          {!meetingLink && (
            <span
              className={cn(
                "rounded-full font-semibold bg-gray-800 px-2 hover:bg-orange-500 cursor-pointer",
                smooth_hover
              )}
          ...
          <Dialog>
            ...
            <DialogContent>
              ...
              <div className="flex gap-x-2 w-full">
                <span className="w-[150px] bg-red-800 flex justify-center rounded-sm hover:opacity-90">
                  Yes
                </span>
                <DialogClose className="w-[150px] bg-gray-700 flex justify-center rounded-sm hover:opacity-90">
                  Cancel
                </DialogClose>
              </div>
            </DialogContent>
